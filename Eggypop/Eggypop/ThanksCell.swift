...
final class ThanksCell: UICollectionViewCell {
    ...
    let acknowledgementsTextView: UITextView = {
        ...
        text.font = UIFont.init(name: "LucidaGrande", size: 0)
        text.font = UIFont.systemFont(ofSize: 16)
        text.text = "A number of people were kind enough to contribute to the creation of this app, and I'm most grateful. In alphabetical order they are Alexander Clark, Christopher Webb, Chiara Benni, Eric Camacho, Icons8, Jenny Shalai, Joel Bell, Jim Campagno and Valera Marsel – thank you all! 🙏"
        text.textContainerInset = UIEdgeInsets(top: 0, left: -4, bottom: 0, right: 0)
        text.backgroundColor = .white
        text.translatesAutoresizingMaskIntoConstraints = false
        text.isSelectable = false
